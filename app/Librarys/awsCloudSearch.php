...
class awsCloudSearch {
    ...
    public $calendar_method = "2013-01-01";
   ...
   */
    ...
    {
        $this->search_domain = env('AWS_SEARCH_DOMAIN');
        $this->domain_id = env('AWS_DOMAIN_ID');
        $this->search_host = "http://doc-".$this->search_domain."-".$this->domain_id.".ap-southeast-1.cloudsearch.amazonaws.com";
        $this->document_endpoint = "http://doc-".$this->search_domain."-".$this->domain_id.".ap-southeast-1.cloudsearch.amazonaws.com/" . $this->calendar_method;
        $this->search_endpoint = "http://search-".$this->search_domain."-".$this->domain_id.".ap-southeast-1.cloudsearch.amazonaws.com/" . $this->calendar_method;       
    }
	/**
